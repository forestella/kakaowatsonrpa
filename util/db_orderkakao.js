...
cloudant.db.create(process.env.CLOUDANT_ORDERKAKAO_DB, (err, res) => {
    if (err) { 
        ...
        var db = cloudant.db.use(process.env.CLOUDANT_ORDERKAKAO_DB);
...
module.exports = {
    'db': cloudant.db.use(process.env.CLOUDANT_ORDERKAKAO_DB)
};